        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    monthly_budget = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_report_jobs_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    percentage_used = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    alert_sent_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_budget_alerts", x => x.id);
                    table.ForeignKey(
                        name: "FK_budget_alerts_categories_category_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_budget_alerts_category_id",
                table: "budget_alerts",
                column: "category_id");

            migrationBuilder.CreateIndex(
                name: "IX_budget_alerts_user_id",
                table: "budget_alerts",
                column: "user_id");
